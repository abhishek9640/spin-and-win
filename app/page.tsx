...
export default function Home() {
  return (
    <div className="min-h-screen bg-white text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50">
          ...
          <div className="grid gap-12 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-center">
            <div className="flex flex-col justify-center space-y-8">
              <div className="space-y-6">
                ...
                <p className="max-w-[600px] text-neutral-500 text-xl leading-relaxed dark:text-neutral-400">
      ...
      {/* How It Works */}
      <section className="py-20 border-t border-neutral-900/10 dark:border-neutral-50/10">
        <div className="container px-4 md:px-6">
      ...
      {/* Footer */}
      <footer className="border-t border-neutral-900/10 py-6 dark:border-neutral-50/10">
        <div className="container px-4 md:px-6">
